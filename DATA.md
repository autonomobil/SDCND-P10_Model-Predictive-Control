...
* `ptsx` (Array<float>) - The global x positions of the target waypoints.
* `ptsy` (Array<float>) - The global y positions of the target waypoints. This corresponds to the z coordinate in Unity
